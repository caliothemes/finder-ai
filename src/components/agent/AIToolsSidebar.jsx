...
export default function AIToolsSidebar({ onToolSelect }) {
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div 
        className={`fixed left-0 lg:left-72 top-[72px] md:top-[80px] h-[calc(100vh-72px)] md:h-[calc(100vh-80px)] transition-all duration-300 z-40 flex ${
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto py-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center py-2 mb-4 transition-colors"
            style={{ 
